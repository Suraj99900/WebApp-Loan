...
function exportToExcel($data)
{
    ...
    $sheet->setCellValue("I$row", $totals['Total Payment Done'])->getStyle("I$row")->getFont()->setBold(true);
...
function exportToPDF($data)
{
    ...
    $pdf->SetHeaderData('', 0, 'Revenue Report', 'Generated by Web App Loan', [0, 64, 255], [0, 64, 128]);
