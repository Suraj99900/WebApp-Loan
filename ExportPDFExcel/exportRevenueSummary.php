...
if (isset($_GET['export'])) {
    ...
    $monthlyBreakdown = formatMonthlyBreakdownData($monthlyBreakdown['aMonthlyData']);
    if ($exportType === 'excel') {
...
function exportToPDF($data)
{
    ...
    $pdf->SetHeaderData('', 0, 'Monthly Revenue Breakdown', 'Generated by SM Loan', [0, 64, 255], [0, 64, 128]);
